...
### <a id='css-syntax'>CSS синтаксис</a>
...
### <a id='css-declaration-order'>Порядок объявления</a>
...
### <a id='css-import'>Не используйте @import</a>
...
### <a id='css-media-queries'>Место для media query</a>
...
### <a id='css-prefixed-properties'>Свойства с префиксами</a>
...
### <a id='css-single-declarations'>Правила с одиночными объявлениями</a>
...
### <a id='css-shorthand'>Сокращенная запись</a>
...
### <a id='css-comments'>Комментарии</a>
...
### <a id='css-selectors'>Селекторы</a>
...
### <a id='css-organization'>Организация кода</a>
