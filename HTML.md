...
### <a id="html-doctype">HTML5 doctype</a>
...
### <a id="html-lang">Атрибут языка</a>
...
### <a id="html-ie-compatibility-mode">Режим совместимости Internet Explorer</a>
...
### <a id="html-encoding">Кодировка символов</a>
...
### <a id="html-style-script">Подключение CSS и JavaScript</a>
...
### <a id="html-file-name">Название файлов</a>
...
### <a id="html-identificators">Идентификаторы</a>
...
### <a id="html-attribute-order">Порядок атрибутов</a>
...
### <a id="html-boolean-attributes">Логические атрибуты</a>
...
### <a id="html-form">Формы, элементы и атрибуты элементов форм</a>
...
### <a id="html-links-and-protocol">Ссылки и протоколы</a>
...
- Телефоны, email-адреса и Skype-контакт должны быть ссылками:
	...
	- `mailto:sales@site.com` - для указания e-mail.
	- `skype:skype?chat` - для указания Skype-контакта.

```html
<a href="tel:+79876543210">+7-987-654-32-10</a>
<a href="mailto:mail@site.com">Напишите нам на почту</a>
<a href="skype:skype?chat">Напишите нам в Skype</a>
```



### <a id="html-reducing-markup">Сокращение разметки</a>
...
<!-- Лучше -->
<img class="avatar" src="avatars/avatar.png" alt="avatar">
```



### <a id="html-images">Изображения</a>
...
<img src="images/image.png" alt="image" width="128" height="64">
```



### <a id="html-javascript">Взаимодействие HTML и JavaScript</a>
...
### <a id="html-comments">Комментирование кода</a>
